...
/**
 * Directory `/` — agents listed BY ENS NAME with live human-weighted stars and a live
 * ENSIP-25 verification badge (on-chain). Scores come from the backend (read from chain);
 * the badge is computed on the client from the on-chain IdentityRegistry. Degrades
 * gracefully when backend / chain / addresses are absent.
 */
...
export default function DirectoryPage() {
  ...
  const shownAgents =
    agents && spoofedDemo ? [...agents, spoofedDemo] : agents;
