...
///         getSummary(agentId, [gate], "retinai", "") reads back the mirrored entry.
contract DeployCanonicalFork is Script {
    ...
    string constant AGENT_URI = "ipfs://retinai-research-agent";
    string constant AGENT_ENS = "research-agent.retinai.eth";
