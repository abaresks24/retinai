...
///         additionally forward each accepted review to canonical 8004 as a tagged `"humanrank"`
...
///             canonicalReputation.getSummary(agentId, [address(this)], "humanrank", "")
...
contract CanonicalReviewGate {
    ...
    ///         then mirror-writes a tagged `"humanrank"` entry to the canonical ERC-8004 registry.
    ///
        ...
        onlyAttestor
    {
        ...
        // tag1 = "humanrank" so 8004 readers can filter to human-gated feedback, and the anon
