...
/// @notice Deploys the RetinAI contract stack to the local anvil chain and writes the shared
...
contract Deploy is Script {
    ...
    function _writeAddresses(
        ...
        string[3] memory ensNames = [
            string("research-agent.retinai.eth"),
            string("translator-agent.retinai.eth"),
            string("code-agent.retinai.eth")
        ];
