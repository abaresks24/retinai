...
interface ICanonicalReputation {
    ...
    /// @param tag1           free-form tag, filterable in getSummary (HumanRank uses "humanrank")
    ...
    /// @param feedbackHash   32-byte commitment (HumanRank carries the anon nullifierHash here)
    ...
    ///         who chooses whom to trust — which is exactly the missing primitive HumanRank adds.
